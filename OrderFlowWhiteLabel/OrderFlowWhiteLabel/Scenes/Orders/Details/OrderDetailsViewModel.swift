...
class OrderDetailsViewModel: OrderDetailsViewModeling {
    ...
    private func fetchOrder() async throws {
        ...
        let produtoMock = Produto(id: UUID(), distribuidoraId: UUID(), nome: "Café", quantidade: 2, precoUnidade: 10.50, estoque: 10, imageName: "", tagText: "tagHere")
        ...
        let produtoMock2 = Produto(id: UUID(), distribuidoraId: UUID(), nome: "Leite", quantidade: 1, precoUnidade: 8.50, estoque: 8, imageName: "", tagText: "tagHere")
        ...
        let produtoMock3 = Produto(id: UUID(), distribuidoraId: UUID(), nome: "Repolho", quantidade: 8, precoUnidade: 2.70, estoque: 12, imageName: "", tagText: "tagHere")
